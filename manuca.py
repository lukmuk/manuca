...
def printHelp():
    ...
    print('  "Effective atomic number" -> Various forms of the effective atomic number for special interactions.')
    ...
    print(f'MANuCa version: {version}, Author: Lukas Gruenewald')
    print('==============================================')
